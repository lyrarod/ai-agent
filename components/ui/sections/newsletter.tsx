  ...
  return (
    <section id="newsletter" className="flex items-center">
      <div className="container">
        <div className="flex flex-col items-center justify-center px-4 py-12 rounded-md bg-gradient-to-r from-primary to-emerald-700 gap-x-4 gap-y-2 xl:flex-row">
